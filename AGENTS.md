...
5. Treat `run_farm.py` (repo root) as the primary entry point unless the user explicitly says otherwise.
...
```text
run_farm.py                        - main live runner (repo root)
...
.venv\Scripts\python toolsootstrap_gem_classifier.py
