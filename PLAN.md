...
| 2026-08-15 | Neither provider invents a target when there is nothing to close | Both answered `found=false` on a night frame with no panel -- the more dangerous failure mode, avoided |
